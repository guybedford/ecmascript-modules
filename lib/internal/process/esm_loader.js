...
const format = require('internal/options').getOptionValue('--format');
if (format && format !== 'commonjs' && format !== 'module')
  throw new ERR_INVALID_TYPE_FLAG(format);
exports.formatFlag = format;
